...
{
    class E00_IrisClassification : ITask
    {
        ...
        public void Run()
        {
            Console.WriteLine($"Create a ML.NET environment");

            var mlContext = new MLContext();

            // If working in Visual Studio, make sure the 'Copy to Output Directory'
            // property of iris-data.txt is set to 'Copy always'
            string dataPath = Path.Combine("00-IrisClassification" ,  "iris-data.txt");
            var reader = mlContext.Data.TextReader(new Microsoft.ML.Runtime.Data.TextLoader.Arguments()
            {
                Separator = ",",
                HasHeader = true,
                Column = new[]
            ...
            Console.WriteLine($"Train your model based on the data set");
